...
#endif
#if Oculus
    static Transform GetTransform() //정보를 읽어온다 Get / Set은 설정할 때 값을 바꾸고 싶을 때 사용 
    {
...
# endif
    ...
    // ���� ��Ʈ�ѷ�
    static Transform lHand; //얘가 진짜 
    // ���� ��ϵ� ���� ��Ʈ�ѷ��� ã�� ��ȯ
    public static Transform LHand //얘는 그냥 외부에 오픈 소스 
    {
        get
        {
            if (lHand == null)
    ...
    public static Vector3 RHandDirection
    {
        get
        {
            ...
            RHand.forward = direction;//기하 벡터로 이해 그래프 상으로 원점으로 갔다가 다시 B로 간다~ 이렇게 생각하면 -로 가는게 맞음 
            return direction;
#elif Oculus
